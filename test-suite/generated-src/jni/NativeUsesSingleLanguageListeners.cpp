...
#include "NativeCsOnlyListener.hpp"
...
void NativeUsesSingleLanguageListeners::JavaProxy::callForCs(const std::shared_ptr<::testsuite::CsOnlyListener> & c_l) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUsesSingleLanguageListeners>::get();
    jniEnv->CallVoidMethod(Handle::get().get(), data.method_callForCs,
                           ::djinni::get(::djinni_generated::NativeCsOnlyListener::fromCpp(jniEnv, c_l)));
    ::djinni::jniExceptionCheck(jniEnv);
}
std::shared_ptr<::testsuite::CsOnlyListener> NativeUsesSingleLanguageListeners::JavaProxy::returnForCs() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUsesSingleLanguageListeners>::get();
    auto jret = jniEnv->CallObjectMethod(Handle::get().get(), data.method_returnForCs);
    ::djinni::jniExceptionCheck(jniEnv);
    return ::djinni_generated::NativeCsOnlyListener::toCpp(jniEnv, jret);
}
...
CJNIEXPORT void JNICALL Java_com_dropbox_djinni_test_UsesSingleLanguageListeners_00024CppProxy_native_1callForCs(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_l)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::testsuite::UsesSingleLanguageListeners>(nativeRef);
        ref->callForCs(::djinni_generated::NativeCsOnlyListener::toCpp(jniEnv, j_l));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}

CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_UsesSingleLanguageListeners_00024CppProxy_native_1returnForCs(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::testsuite::UsesSingleLanguageListeners>(nativeRef);
        auto r = ref->returnForCs();
        return ::djinni::release(::djinni_generated::NativeCsOnlyListener::fromCpp(jniEnv, r));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, 0 /* value doesn't matter */)
}
